            ...
            <div className='h-[10vh] w-full flex bg-black justify-center max-lg:hidden z-50 fixed' >
                <div className="w-90p h-full flex justify-between items-center text-white">
                    ...
                    <div className="w-60p items-center flex justify-end gap-4 max-xl:gap-2">
                            <span className="text-md max-xl:text-sm font-semibold cursor-pointer"><a href="https://app.recruitinn.ai/candidate-self"> Apply As A Candidate</a></span>
                            ...
                            <ul className={styles.dropdown_menu}>
                                <li><a href="https://app.recruitinn.ai/candidate-login">Login As Candidate</a></li>
                                <li><a href="https://app.recruitinn.ai/client-login">Login As Client</a></li>
                            </ul>
                            </div>
                                <a href="http://localhost:3000/client-signup"><button className="px-10 py-3.5 text-md max-xl:text-sm btn-gradient rounded-3xl font-semibold">Recruit A Talent</button></a>
                            </div>
                    </div>
                </div>
            </div>
