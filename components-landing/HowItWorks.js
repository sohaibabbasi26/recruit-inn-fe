  ...
  const items = [
    {
      ...
      description: "Where you can specify your required skills & expertise",
    },
    {
      ...
      <div className="w-100p h-[100%] flex flex-col items-center justify-center mb-[2rem] text-white">
        <div className="w-90p h-10p flex justify-between items-center mt-[2rem]">
          <div className="w-40p max-lg:w-50p h-[100%] text-white">
            <h2 className="text-3xl text-black dark:text-white font-sans font-semibold max-lg:text-xl">
              How It Works
            </h2>
            <p className="text-[0.75rem] text-steel dark:text-smallText">
              All new experience to get the things done in few easy steps
            </p>
          </div>

          <div className="w-40p h-[100%] text-black dark:text-white flex items-center justify-end">
            <button className="text-[0.75rem] max-lg:  rounded-3xl py-3 px-6 btn-gradient font-sans font-semibold">
              Recruit A Talent
            </button>
          </div>
        </div>
        ...
        <div className="w-[100%] h-80p flex flex-col items-center gap-4 text-white ">
          <div
            className={`${
              theme === "dark"
                ? style["fourth-sec-gradient"]
                : style["fourth-sec-gradient-white"]
            } rounded-l-3xl max-md:rounded-3xl w-[90%] `}
          >
                    ...
                    {items.map((item, index) => (
                      ...
                      >
                        ...
                        <div className="max-lg:w-[100%]">
                          <h3 className="max-lg:w-[100%] text-2xl font-sans font-semibold  text-black dark:text-white ">
                            {item.title}
                          </h3>
