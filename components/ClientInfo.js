      ...
      <div className={styles.superContainer}>
        ...
        <div className={styles.inputField}>
          ...
          <select onChange={(e) => setCity(e.target.value)}>
            ...
            <option value={country === "Pakistan" ? "Karachi" : "Mumbai"}>
              {country === "Pakistan" ? "Karachi" : "Mumbai"}
            </option>
            <option value={country === "Pakistan" ? "Lahore" : "Kolkata"}>
              {country === "Pakistan" ? "Lahore" : "Kolkata"}
            </option>
          </select>
        </div>
      </div>
