      ...
      <div className={styles.overall_report_wrapper}>
        ...
        {flow === "candidate" && (
            ...
            >
              <div className={styles.enhance_skills}>
                <p>
                  ...
                  Illum repellat cupiditate possimus molestias amet eius,
                  impedit ducimus ad saepe veniam.
                </p>
          ...
          Doloremque aliquam cum fugit. */}
                      ...
                      <p
                        className={
                          styles.course_recommendation_card_content_level
                        }
                      >
                        <CourseLevelSvg />
                      ...
                      <p
                        className={
                          styles.course_recommendation_card_content_price
                        }
                      >
                        ...
                        <span>
                          {" "}
                          $
                          {recommendedCourse?.amount -
                            recommendedCourse?.discount}
                        </span>
                      </p>
                  ...
                  <div className={styles.course_recommendation_content}>
                    <p>
                      Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                      Iste nihil distinctio omnis assumenda facere voluptates
                      officia iure neque id libero!
                    </p>
                  </div>
                </div>
              </ReportSection>
...
function Item({ keyy, value }) {
  return (
    <div className={styles.items}>
      <p>{keyy}</p>
      <p style={keyy === "email" ? { textTransform: "lowercase" } : null}>
        {value}
      </p>
    </div>
  );
