...
//         if (isRecording) {
//             await stopAndHandleRecording(); // Assumes this function handles stopping and sets `isRecording` to false
//         }

//         // Now, either submit the test if it's the last question or move to the next question
//         if (isLastQuestion) {
//             submitTestHandler();
//         } else {
//             toggleComponent(); // This function needs to be prepared to handle being called in this context
//         }
//     };
...
//     //     // Start the interval only if the test has started
//     //     if (hasStarted) {
//     //         intervalId = setInterval(() => {
//     //             setTimeLeft((prevTimeLeft) => {
//     //                 if (prevTimeLeft > 0) {
...
//                 // const response = await fetch(`http://18.190.133.234/v1/speech-to-text`, {
//                 method: 'POST',
//                 headers: {
//                     'Content-Type': 'application/json',
//                 },
