...
//                                                 : ''
//                                         }
//                                         onClick={() => handleItemClick('AllClients')}>All  <span className={styles.space}  ></span> <Image src='/All.svg' width={listItemSize} height={listItemSize} /></li>
//                                     <li 
//                                         className={
//                                             activeItem === 'Request' ?
//                                                 `${styles.dashboardButton} ${styles.active}`
//                                                 : ''
//                                         }
//                                         onClick={() => handleItemClick('Request')}>Request <span className={styles.space}  ></span>   <Image src='/Request.svg' width={listItemSize} height={listItemSize} /></li>
//                                     <li
//                                         className={
//                                             activeItem === 'Active' ?
//                                                 `${styles.dashboardButton} ${styles.active}`
//                                                 : ''
//                                         }
//                                         onClick={() => handleItemClick('Active')}>Active <span className={styles.space}  ></span>  <Image src='/Active.svg' width={listItemSize} height={listItemSize} /></li>
//                                     <li
//                                         className={
